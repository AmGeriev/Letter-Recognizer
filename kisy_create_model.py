...
from Tensaflow.model import create_model  # Beispiel, wenn model.py im Ordner Tensaflow ist
...
folder_path = r"C:\1BHELHTLInn\4BHEL\KISY_Korber\Tensaflow\Alphabet_recognizer\Buchstaben_ende"
